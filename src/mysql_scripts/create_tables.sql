...
('info1', 'GR', ' 	Καλό Ταξίδι ! Μπορείτε σε αυτή την σελίδα να περάσετε το χρόνο σας ευχάριστα .Να συμμετέχετε στη μουσική που θα ακουστεί και στην προβολή ταινίας ( για μεγάλα ταξίδια ) . Μπορείτε να βρείτε το Λεωφορείο στα social media (Facebook) ώστε να αλληλεπιδράσετε μεταξύ σας, να αφήσετε σχόλια και τέλος να βρείτε το λεωφορείο στο χάρτη . Χαιρόμαστε που ταξιδεύετε μαζί μας . 	Το παρόν υλοποιήθηκε ως Διπλωματική εργασία στο τμήμα Μηχανικών Υπολογιστών και Πληροφορικής του Πανεπιστημίου Ιωαννίνων με επιβλέποντα τον Καθηγητή Ιωάννη Φούντο.'),
('info1', 'EN', 'Have a nice trip ! You can spend your time with pleasure here .You can send your preferences about Music and Movie that you like to watch (for long distance routes). You can also find the bus with social media (Facebook) , in which you can react between you and also find it on map (Foursquare). Thank you for travelling with us . This program created as a Thesis for Department of Computer Engineer and Computer Science of University of Ioannina with supervisor Professor Ioannis Foudos.   '),
