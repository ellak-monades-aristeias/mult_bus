...
<?php
    ...
    echo "<li> <a href=\"music_list.php?lang=GR&thesh=$thesh&pass=$pass\"> GR </a> </li>";
    echo "<li> <a href=\"music_list.php?lang=EN&thesh=$thesh&pass=$pass\"> EN </a> </li>";
    echo "</ul>";
    ...
    if ($thesh==-1 || $pass==-1 || correctPass($thesh,$pass)==0 ) {
        ...
        $query = "SELECT id, name FROM `tragoudia`";
        //echo $query;
        ...
        while ($row=mysqli_fetch_array($result)) {
            echo "<li>\n";
            echo "<a href=\"music_vote.php?lang=$lang&thesh=$thesh&pass=$pass&id=$row[0]\"> <div>" . $row[1] . "</div> </a>\n";
            echo "</li>\n";
        }
        echo "</ul>\n";
        echo "</form>\n";
